...
const createNext = ssrContext => opts => {
  ...
  if (opts.path.indexOf('http') !== 0 && ('/wilde_spieth/prototypes/1/dist/' !== '/' && opts.path.indexOf('/wilde_spieth/prototypes/1/dist/') !== 0)) {
    opts.path = urlJoin('/wilde_spieth/prototypes/1/dist/', opts.path)
  }
  // Avoid loop redirect
