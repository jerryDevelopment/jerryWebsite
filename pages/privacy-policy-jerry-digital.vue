<template>
  <section class="container screen fixed scrollable legal-container bg-grey-1" style="z-index: 100;">
    <div class="cor-tr fixed" style="z-index: 2;">
        <div class="col col-100 pad-lr-2 pad-tb-1-25 align-center" @click="closePrivacyPolicy()">
          <button type="button">
    ...
    <div class="c-frame">
      <div class="c-area c-area-m">
        <div class="col col-unit-12 pad-lr-0-5 pad-t-8 pad-b-4 align-center">
          <svg class="legal-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 342.81 235.16">
            <g>
        ...
        <div class="col-unit-12 pad-lr-1 pad-b-10" v-html="privacyPolicyCurrentLanguageText"></div>
      </div>
    </div>
  </section>
</template>
...
export default {
  head() {
    return {
      ...
      title: this.privacyPolicyCurrentLanguage.meta.title,
      meta: [
  ...
  nuxtI18n: {
    paths: {
      de: '/datenschutz-jerry-digital', // -> accessible at /about-us (no prefix since it's the default locale)
      en: '/privacy-policy-jerry-digital'
    }
  },
  scrollToTop: false,
  data() {
