<template>
  <section class="container screen fixed scrollable legal-container bg-grey-1" style="z-index: 100;">
    <div class="cor-tr fixed" style="z-index: 2;">
        <div class="col col-100 pad-lr-2 pad-tb-1-25 align-center" @click="closeImprint()">
          <button type="button">
    ...
    <div class="c-frame">
      <div class="c-area c-area-m">
        ...
        <div class="col-unit-12 pad-lr-1 pad-b-10" v-html="imprintJerryDigitalCurrentLanguageText"></div>
      </div>
    </div>
  </section>
</template>
...
export default {
  head() {
    return {
      ...
      title: this.imprintJerryDigitalCurrentLanguage.meta.title,
      meta: [
  ...
  nuxtI18n: {
    paths: {
      de: '/impressum-jerry-digital', // -> accessible at /about-us (no prefix since it's the default locale)
      en: '/imprint-jerry-digital'
    }
  },
  scrollToTop: false,
  data() {
